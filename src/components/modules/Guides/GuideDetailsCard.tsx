    ...
    <>
      ...
      <div className="text-center mb-10 px-4">
        <h1 className="text-2xl md:text-4xl font-extrabold text-gray-800">
          Meet Your <span className="text-orange-500">Local Guide</span>
        </h1>
        <p className="mt-3 text-gray-600 max-w-2xl mx-auto text-sm md:text-base">
          Explore destinations with experienced local guides. Book, travel and
      ...
      <div className="space-y-6 px-4 md:px-0 ">
        {/* Guide Info */}
        <div className="flex flex-col md:flex-row items-center md:items-start justify-center md:justify-between p-6 border rounded-2xl shadow-lg bg-linear-to-r from-white to-gray-50">
          {/* Guide Image */}
          <div className="flex justify-center w-full md:w-auto">
            <ClientOnly>
              <Image
                ...
                height={500}
                alt={guide.name}
                className="w-40 h-40 md:w-60 md:h-60 rounded-full object-cover border-4 border-orange-400 shadow-md"
              />
            </ClientOnly>
          </div>
          ...
          <div className="mt-6 md:mt-0 md:ml-6 flex-1 text-center md:text-left">
            ...
            <div className="mt-3 space-y-2 text-gray-700">
              ...
              <p>Phone: {guide.phone || "N/A"}</p>
              <p>Location: {guide.address || "N/A"}</p>
              <p>
                Language:{" "}
          ...
          {/* Booking Button */}
          <div className="mt-6 md:mt-0 flex flex-col items-center space-y-6">
            <Button
            ...
            <div className="text-center">
              <div className="flex gap-1 text-orange-400 justify-center">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 mb-4 text-center md:text-left">
            Honest reviews from tourists who booked this guide
          </p>
          <div>
            {" "}
